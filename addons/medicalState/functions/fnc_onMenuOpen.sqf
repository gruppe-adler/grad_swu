...
if (ace_interact_menu_fnc_menuBackground == 1) then {[QGVAR(id), true] call EFUNC(common,blurScreen)};
if (ace_interact_menu_fnc_menuBackground == 2) then {0 cutRsc [QEGVAR(interact_menu,menuBackground), "PLAIN", 1, false]};
